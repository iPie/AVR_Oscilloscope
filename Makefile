...
# -U flash:w:d:\Soft\Java\NetBeansProjects\AVR_Oscilloscope\main.hex:i -c usbasp -P usb -p m16
...
MSG_ISIS_COPY = Copying files to ISIS project directory
...
# Default target.
all: begin gccversion sizebefore build sizeafter proteus end
...
# Copy main.hex to ISIS directory.
